...
badd +192 src/include/BoardSupport/hardware_abstractions.h
...
badd +12 src/McRTOS/McRTOS_interrupt_service_routines_arm_cortex_m.s
...
badd +967 src/BoardSupport/FRDM-K64F/k64f_soc_hardware_abstractions.c
...
badd +1 src/include/BoardSupport/FRDM-K64F/MK64F12.h
...
badd +0 ~/myprojects/embsys/projects/mcrtos/src/include/mcrtos/McRTOS_arm_cortex_m_macros.s
silent! argdel *
...
setlocal fen
silent! normal! zE
let s:l = 199 - ((0 * winheight(0) + 12) / 24)
...
exe 'vert 6resize ' . ((&columns * 88 + 103) / 207)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 3128 - ((0 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3128
...
setlocal fen
silent! normal! zE
let s:l = 105 - ((13 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
wincmd w
argglobal
edit ~/myprojects/embsys/projects/mcrtos/src/include/mcrtos/McRTOS_arm_cortex_m_macros.s
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 51 + 27) / 54)
exe 'vert 1resize ' . ((&columns * 42 + 103) / 207)
exe '2resize ' . ((&lines * 34 + 27) / 54)
exe 'vert 2resize ' . ((&columns * 101 + 103) / 207)
exe '3resize ' . ((&lines * 12 + 27) / 54)
exe 'vert 3resize ' . ((&columns * 101 + 103) / 207)
exe '4resize ' . ((&lines * 3 + 27) / 54)
exe 'vert 4resize ' . ((&columns * 101 + 103) / 207)
exe '5resize ' . ((&lines * 9 + 27) / 54)
exe 'vert 5resize ' . ((&columns * 62 + 103) / 207)
exe '6resize ' . ((&lines * 10 + 27) / 54)
exe 'vert 6resize ' . ((&columns * 62 + 103) / 207)
exe '7resize ' . ((&lines * 7 + 27) / 54)
exe 'vert 7resize ' . ((&columns * 62 + 103) / 207)
exe '8resize ' . ((&lines * 9 + 27) / 54)
exe 'vert 8resize ' . ((&columns * 62 + 103) / 207)
exe '9resize ' . ((&lines * 1 + 27) / 54)
exe 'vert 9resize ' . ((&columns * 62 + 103) / 207)
exe '10resize ' . ((&lines * 10 + 27) / 54)
exe 'vert 10resize ' . ((&columns * 62 + 103) / 207)
argglobal
enew
file __Tag_List__
setlocal fdm=manual
...
setlocal fen
silent! normal! zE
let s:l = 972 - ((3 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
972
...
setlocal fen
silent! normal! zE
let s:l = 772 - ((4 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
772
