...
badd +509 src/Applications/autonomous_car/main.c
...
exe 'vert 9resize ' . ((&columns * 102 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
exe 'vert 1resize ' . ((&columns * 110 + 102) / 205)
exe '2resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 110 + 102) / 205)
exe '3resize ' . ((&lines * 17 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 110 + 102) / 205)
exe '4resize ' . ((&lines * 15 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 110 + 102) / 205)
exe '5resize ' . ((&lines * 11 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 94 + 102) / 205)
exe '6resize ' . ((&lines * 24 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 94 + 102) / 205)
exe '7resize ' . ((&lines * 14 + 26) / 53)
exe 'vert 7resize ' . ((&columns * 94 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 29 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal fen
silent! normal! zE
let s:l = 2866 - ((0 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2866
...
setlocal fen
silent! normal! zE
let s:l = 27 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal fen
silent! normal! zE
let s:l = 788 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
788
...
exe 'vert 1resize ' . ((&columns * 99 + 102) / 205)
...
exe 'vert 4resize ' . ((&columns * 105 + 102) / 205)
exe '5resize ' . ((&lines * 16 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 105 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
exe '3resize ' . ((&lines * 30 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 81 + 102) / 205)
exe '4resize ' . ((&lines * 20 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 81 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 32 - ((0 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 26 + 26) / 53)
exe 'vert 1resize ' . ((&columns * 160 + 102) / 205)
exe '2resize ' . ((&lines * 26 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 44 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
exe 'vert 1resize ' . ((&columns * 132 + 102) / 205)
exe '2resize ' . ((&lines * 11 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 132 + 102) / 205)
exe '3resize ' . ((&lines * 4 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 132 + 102) / 205)
exe '4resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 72 + 102) / 205)
exe '5resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 72 + 102) / 205)
exe '6resize ' . ((&lines * 6 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 72 + 102) / 205)
exe '7resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 7resize ' . ((&columns * 72 + 102) / 205)
exe '8resize ' . ((&lines * 12 + 26) / 53)
exe 'vert 8resize ' . ((&columns * 72 + 102) / 205)
exe '9resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 9resize ' . ((&columns * 72 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
exe 'vert 1resize ' . ((&columns * 147 + 102) / 205)
exe '2resize ' . ((&lines * 33 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 147 + 102) / 205)
exe '3resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 147 + 102) / 205)
exe '4resize ' . ((&lines * 39 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 57 + 102) / 205)
exe '5resize ' . ((&lines * 11 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 57 + 102) / 205)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 55 - ((0 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal fen
silent! normal! zE
let s:l = 366 - ((0 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
366
