...
badd +1 src/Applications/McRTOS-FRDM/module.mk
...
exe '3resize ' . ((&lines * 6 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 96 + 99) / 199)
exe '4resize ' . ((&lines * 13 + 26) / 53)
...
exe 'vert 9resize ' . ((&columns * 96 + 99) / 199)
exe '10resize ' . ((&lines * 7 + 26) / 53)
exe 'vert 10resize ' . ((&columns * 96 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 209 - ((7 * winheight(0) + 12) / 24)
...
wincmd w
argglobal
edit src/Applications/McRTOS-FRDM/module.mk
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
exe 'vert 3resize ' . ((&columns * 102 + 99) / 199)
exe '4resize ' . ((&lines * 4 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 102 + 99) / 199)
exe '5resize ' . ((&lines * 11 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 96 + 99) / 199)
exe '6resize ' . ((&lines * 24 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 96 + 99) / 199)
...
setlocal fen
silent! normal! zE
let s:l = 409 - ((14 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
409
...
setlocal fen
silent! normal! zE
let s:l = 2372 - ((0 * winheight(0) + 2) / 4)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2372
...
exe 'vert 1resize ' . ((&columns * 111 + 99) / 199)
exe '2resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 111 + 99) / 199)
exe '3resize ' . ((&lines * 9 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 87 + 99) / 199)
exe '4resize ' . ((&lines * 26 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 87 + 99) / 199)
exe '5resize ' . ((&lines * 3 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 87 + 99) / 199)
exe '6resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 87 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 3128 - ((24 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3128
...
setlocal fen
silent! normal! zE
let s:l = 797 - ((9 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
797
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 96 + 99) / 199)
...
exe 'vert 4resize ' . ((&columns * 102 + 99) / 199)
exe '5resize ' . ((&lines * 31 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 102 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 474 - ((5 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
474
...
exe 'vert 1resize ' . ((&columns * 117 + 99) / 199)
exe '2resize ' . ((&lines * 23 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 117 + 99) / 199)
exe '3resize ' . ((&lines * 29 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 81 + 99) / 199)
exe '4resize ' . ((&lines * 21 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 81 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 32 - ((0 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
setlocal fen
silent! normal! zE
let s:l = 139 - ((0 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 116 + 99) / 199)
exe 'vert 2resize ' . ((&columns * 82 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 330 - ((0 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
330
...
setlocal fen
silent! normal! zE
let s:l = 74 - ((0 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
exe 'vert 1resize ' . ((&columns * 95 + 99) / 199)
exe '2resize ' . ((&lines * 25 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 95 + 99) / 199)
exe '3resize ' . ((&lines * 9 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 103 + 99) / 199)
exe '4resize ' . ((&lines * 6 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 103 + 99) / 199)
exe '5resize ' . ((&lines * 1 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 103 + 99) / 199)
exe '6resize ' . ((&lines * 12 + 26) / 53)
exe 'vert 6resize ' . ((&columns * 103 + 99) / 199)
exe '7resize ' . ((&lines * 19 + 26) / 53)
exe 'vert 7resize ' . ((&columns * 103 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 25 + 26) / 53)
exe 'vert 1resize ' . ((&columns * 88 + 99) / 199)
exe '2resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 88 + 99) / 199)
exe '3resize ' . ((&lines * 14 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 88 + 99) / 199)
exe '4resize ' . ((&lines * 39 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 110 + 99) / 199)
exe '5resize ' . ((&lines * 11 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 110 + 99) / 199)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 372 - ((4 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
372
