...
#   endif /* _RELIABILITY_CHECKS_ */
    ...
    /**
     * Buffer where the most recent output generated by capture_fdc_msg_printf()
     * is stored
     */
    char fdc_msg_buffer[RTOS_FDC_MSG_BUFFER_SIZE];

    /**
     * Next position to fill in fdc_msg_buffer
     */
    uint16_t fdc_msg_cursor;

    /*
     * Sequence number for next debug message to store in fdc_debug_msg_buffer
     */
    uint16_t fdc_msg_seq_num;
